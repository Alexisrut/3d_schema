...
/**
 * Черновик зоны во время разметки: маркеры опорных точек и контур между ними.
 * Пока точек меньше трёх — рисуем только линию, заливка появляется с третьей.
 */
...
watch(() => props.points, rebuild, { deep: true, immediate: true })
